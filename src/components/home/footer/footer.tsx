      ...
      <div className="mx-auto max-w-7xl px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">
              The AI platform that makes MCP workflows accessible through plain English. Automate anything in 30 seconds.
            </p>
            <div className="flex space-x-4">
              <Link href="https://twitter.com/petal" className="text-muted-foreground hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </Link>
              <Link href="https://github.com/petal" className="text-muted-foreground hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="https://linkedin.com/company/petal" className="text-muted-foreground hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/changelog" className="text-muted-foreground hover:text-white transition-colors">
                  Changelog
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/status" className="text-muted-foreground hover:text-white transition-colors">
                  Status
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-muted-foreground hover:text-white transition-colors">
                  Community
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <p className="text-sm text-muted-foreground">
            © 2025 Petal. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
